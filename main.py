...
class MainWindow(QWidget):
    ...
    def init_ui(self):  # <-- Indentation fixed here
        ...
        self.status_label.setGeometry(50, 230, 400, 50)
    ...
    def open_links_file(self):  # <-- Now correctly inside MainWindow class
        file_path = "links.txt"
    ...
    def start_download(self):
        ...
        for link in links:
            ...
            download_thread.progress_signal.connect(self.update_status)
